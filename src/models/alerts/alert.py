...
class Alert(object):
    ...
    def send(self):
        return requests.post(
            ...
            data={
                ...
                "text": "We've found a deal! ({}). To nagivate to the alert visit {}".format(self.item.url,
                                                        "http://pricing.meetpatel.com/alerts/{}".format(self._id))
            }
        )
    ...
    def delete(self):
        Database.remove(AlertConstants.COLLECTION, {'id': self._id})
